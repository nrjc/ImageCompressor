function [x1,f_x1]=goldensearch3(originalimage,dctcell,quantsteps,refstepsize)
...
f_x1=calculatedeltarmserror2(originalimage,quantisealldct(dctcell,x1),refstepsize);                     % computing values in x points
f_x2=calculatedeltarmserror2(originalimage,quantisealldct(dctcell,x2),refstepsize);
